...
d3f' n size (x0', y0', z0') (x1', y1', z1')
  ...
  | x0' == x1' && y0' == y1' = 8 * (d0 +| dx +| dy +| dxy) +| 4 * (dz +| dZ +| dxz +| dxZ +| dyz +| dyZ +| dxyz +| dxyZ)
  | x0' == x1' && z0' == z1' = 8 * (d0 +| dx +| dz +| dxz) +| 4 * (dy +| dY +| dxy +| dxY +| dyz +| dzY +| dxyz +| dxzY)
  | y0' == y1' && z0' == z1' = 8 * (d0 +| dy +| dz +| dyz) +| 4 * (dx +| dX +| dxy +| dyX +| dxz +| dzX +| dxyz +| dyzX)
  | x0' == x1' && y0' == y1' && z0' == z1' = 8 * (d0 +| dx +| dy +| dz +| dyz +| dxy + dxz +| dxyz)
